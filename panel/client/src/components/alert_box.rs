use vertigo::{DomElement, dom, DomFragment};
...
fn render_progress(progress: Computed<bool>) -> DomFragment {
...
impl AlertBox {
    ...
    pub fn set_content(mut self, content: DomFragment) -> Self {
