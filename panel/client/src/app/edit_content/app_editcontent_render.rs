use vertigo::{Css, bind, dom, transaction, DomNode};
use vertigo::{css};
...
fn render_textarea(state: &AppEditcontent) -> DomNode {
...
pub fn app_editcontent_render(app: &App, state: &AppEditcontent) -> DomNode {
