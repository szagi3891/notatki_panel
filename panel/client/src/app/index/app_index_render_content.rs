        ...
        for item in chunks {
            match item {
                ParseTextItem::Link { url } => {
                    ...
                    let has_open = state.data_state.tab.open_links.tabs_has(&url);
                    ...
                    let open_link = if has_open {
                        let on_click = {
                            ...
                            move || {
                                state.data_state.tab.open_links.tabs_remove(url.clone());
                            }
                        };
                        ...
                        let on_click = {
                            ...
                            move || {
                                state.data_state.tab.open_links.tabs_add(url.clone());
                            }
                        };
